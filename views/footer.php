...
<?php if (!empty($_SESSION['userid'])):?>
	<div class="userlogin">
		<div style="float:left"><img src=""></div><div style="float:left;padding-left:10px;"><h3 style="padding-left:0px"><?php echo $_SESSION['name'];?> | <?php echo $_SESSION['points'];?></h3>
...
<?php else:?>
	...
	<div class="userlogin">
		...
		<h3>E-mail</h3>
		<input type="EMAIL" class="textbox" name="email"  style="width:215px;"/>
		<h3>Password</h3>
...
Powered by buffer-readers<br/>Copyright <?php echo date("Y");?> <a href=# target="_blank">BUFFER-READERS</a>
